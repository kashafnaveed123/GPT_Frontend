...
export default function Profile() {
  const socialLinks = [
    ...
    { Icon: FaIdBadge, href: "#", label: "Portfolio", color: "#2563EB" }
  ];
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-blue-100">
      ...
      <div className="flex justify-center mb-4 sm:mb-6">
        <div className="relative">
          <img
            src={profile}
            alt="Kashaf Naveed"
            className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-blue-200 shadow-lg"
          />
          <div 
      ...
      {/* Title */}
      <p className="text-center text-xs sm:text-sm md:text-base text-blue-600 font-medium mb-4 sm:mb-6 px-2 leading-relaxed">
      ...
      <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
        {socialLinks.map(({ Icon, href, label, color }) => (
          <a
            ...
            className="group relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-blue-50 hover:bg-blue-100 transition-all duration-300 shadow-sm hover:shadow-md"
            title={label}
          >
            <Icon 
      ...
      <div className="mt-6 pt-6 border-t border-blue-100 grid grid-cols-3 gap-2 sm:gap-4">
        ...
        <div className="text-center">
          <div className="text-lg sm:text-xl md:text-2xl font-bold text-blue-600">10+</div>
